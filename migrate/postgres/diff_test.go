  ...
  for _, tt := range tests {
    t.Run(tt.name, func(t *testing.T) {
      ...
      for i := 0; i < 10; i++ {
        ...
        require.NoError(t, err, "NewDatabaseStateFromProto failed")

        actions, err := ComputeDiff("gateway", false, liveClone, targetState)
        require.NoError(t, err, "ComputeDiff failed")

        if i == 0 {
          firstActions = actions
        } else {
          assert.Equal(t, firstActions, actions,
            "run %d produced non-deterministic plan", i)
        }
      }
    })
  }
...
func TestDiffer_Plan(t *testing.T) {
  tests := []struct {
    ...
    {
      name: "create schema and function (nil map panic fix)",
      live: &DatabaseState{Schemas: make(map[string]*SchemaState)},
      target: &postgres.PostgresDatabase{
        Schemas: []*postgres.PostgresSchema{
          {
            ...
            Functions: []*postgres.FunctionDefinition{
              {
                Name:     "do_thing",
                Language: postgres.FunctionLanguage_FUNCTION_LANGUAGE_PLPGSQL,
                Body:     "BEGIN END;",
              },
            },
          },
      ...
      wantActions: []MigrationAction{
        {
          ...
          ObjectType: ObjectSchema,
          Name:       "gateway",
          SQL:        "CREATE SCHEMA IF NOT EXISTS \"gateway\";",
        },
        {
          Type:       ActionTypeCreate,
          ...
          Schema:     "gateway",
          Name:       "do_thing",
          SQL: "CREATE OR REPLACE FUNCTION \"gateway\".\"do_thing\"() " +
      ...
      wantActions: []MigrationAction{
        {
          ...
          Schema:     "public",
          Name:       "users.status",
          SQL: "ALTER TABLE \"public\".\"users\" ALTER COLUMN \"status\" " +
            "DROP DEFAULT;",
        },
        {
          Type:       ActionTypeCreate,
          ...
          Schema:     "public",
          Name:       "users.id",
          SQL: "ALTER TABLE \"public\".\"users\" ADD COLUMN \"id\" " +
    ...
    },
    {
      ...
      wantActions: []MigrationAction{
        ...
        },
        {
          ...
          Schema:     "public",
          Name:       "idx_email",
          SQL: "CREATE UNIQUE INDEX \"idx_email\" ON \"public\".\"users\" " +
            "(\"email\");",
        },
        {
          Type:       ActionTypeCreate,
          ...
          Schema:     "public",
          Name:       "idx_name",
          SQL: "CREATE UNIQUE INDEX \"idx_name\" ON \"public\".\"users\" " +
    ...
    },
    {
      ...
      wantActions: []MigrationAction{
        ...
        },
        {
          ...
          Schema:     "public",
          Name:       "users_pkey",
          SQL: "ALTER TABLE \"public\".\"users\" ADD CONSTRAINT \"users_pkey\" " +
            "PRIMARY KEY (\"id\");",
        },
      },
    },
    {
      ...
      wantActions: []MigrationAction{
        ...
        },
        {
          ...
          Schema:     "public",
          Name:       "fk_author",
          SQL: "ALTER TABLE \"public\".\"posts\" ADD CONSTRAINT \"fk_author\" " +
    ...
    },
    {
      ...
      wantActions: []MigrationAction{
        ...
        },
        {
          ...
          Schema:     "public",
          Name:       "address",
          SQL: "ALTER TYPE \"public\".\"address\" ADD ATTRIBUTE \"zipcode\" " +
        ...
        },
        {
          ...
          Name:          "address.city",
          IsDestructive: true,
          SQL: "ALTER TYPE \"public\".\"address\" DROP ATTRIBUTE \"city\" " +
            "CASCADE;",
        },
      },
    },
      ...
      wantActions: []MigrationAction{
        {
          ...
          SQL: "ALTER TYPE \"public\".\"old_enum\" " +
            "RENAME TO \"scheme_tmp_enum_old_enum\";",
        },
        {
          Type:       ActionTypeRename,
          ObjectType: ObjectEnum,
          Schema:     "public",
          Name:       "new_enum",
          SQL: "ALTER TYPE \"public\".\"scheme_tmp_enum_old_enum\" " +
            "RENAME TO \"new_enum\";",
        },
        {
          Type:       ActionTypeRename,
          ...
          SQL: "ALTER TYPE \"public\".\"old_comp\" " +
            "RENAME TO \"scheme_tmp_comp_old_comp\";",
        },
        {
          Type:       ActionTypeRename,
          ObjectType: ObjectComposite,
          Schema:     "public",
          Name:       "new_comp",
          SQL: "ALTER TYPE \"public\".\"scheme_tmp_comp_old_comp\" " +
            "RENAME TO \"new_comp\";",
        },
        {
          Type:       ActionTypeRename,
          ...
          SQL: "ALTER DOMAIN \"public\".\"old_domain\" " +
            "RENAME TO \"scheme_tmp_dom_old_domain\";",
        },
        {
          Type:       ActionTypeRename,
          ObjectType: ObjectDomain,
          Schema:     "public",
          Name:       "new_domain",
          SQL: "ALTER DOMAIN \"public\".\"scheme_tmp_dom_old_domain\" " +
            "RENAME TO \"new_domain\";",
        },
        {
          Type:       ActionTypeRename,
          ObjectType: ObjectForeignKey,
          ...
          SQL: "ALTER TABLE \"public\".\"posts\" RENAME CONSTRAINT \"fk_old\" " +
            "TO \"scheme_tmp_fk_fk_old\";",
        },
        {
          Type:       ActionTypeRename,
          ObjectType: ObjectForeignKey,
          Schema:     "public",
          Name:       "new_fk",
          SQL: "ALTER TABLE \"public\".\"posts\" RENAME CONSTRAINT " +
            "\"scheme_tmp_fk_fk_old\" TO \"new_fk\";",
        },
      },
    },
  }
  ...
  for _, tt := range tests {
    t.Run(tt.name, func(t *testing.T) {
      ...
      require.NoError(t, err, "NewDatabaseStateFromProto failed")
      actions, err := ComputeDiff(
        "gateway", tt.dbNeedsCreate, tt.live, targetState,
      )
